...
class Generator():
    def __init__(self, data_path, checkpoint_path, user_dir, method):
        ...
        self.args.task = 'translation_prophetnet'
        
        self.args.nbest = 10
        self.args.beam = 10
        self.args.lenpen = 1
        self.args.sampling = True
        self.args.sampling_topk = 10
        self.args.sampling_topp = 0.95
    ...
    def generate(self, inputs, expert):
        ...
        for batch in make_batches(inputs, self.args, self.task, self.max_positions, self.encode_fn):
            ...
            translations = self.task.inference_step(self.generator, self.models, sample, None)
        ...
        for id, src_tokens, hypos in sorted(results, key=lambda x: x[0]):
            ...
            for hypo in hypos[:min(len(hypos), self.args.nbest)]:
                ...
                final_result.append((hypo_str,hypo["score"]))
        return(final_result)
